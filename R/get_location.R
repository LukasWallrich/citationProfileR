...
get_location <- function(df_with_affiliation){
  ...
  #add an empty column country_name where the loop will convert country codes to country names
          ...
          if(is.null(OSM_affiliation_returned)){
            ...
            if(str_count(affiliation, ",") > 0){
              ...
              if(!is.null(OSM_last_phrase)){
                ...
                #HERE get the country name from last_phrase_location
                ...
                #HERE Put NA in country_name[entry]
